...
import { FormInput, FormButton, FormGrayButton } from '../formFields';
  ...
  render() {
    ...
    return (
        <form onSubmit={handleSubmit} className={`${className} account-information-form`}>
            ...
            {//<div className='saccount-information-form__line'></div>
            }
            
            {
              ...
              :
                ...
                onClick={() => this.setState({ showPasswords: !this.state.showPasswords })}
                type='button'
                labelTitle='Password'
                title='Change Password'
                name='change-password'
                component={FormGrayButton}/> 
            }
